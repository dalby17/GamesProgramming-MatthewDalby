...
namespace GamesProgramming_V1
{
    public class Game1 : Game
    {
        ...
        Texture2D background, player, platform, flag, coin, winGame, loseGame;
        Vector2 texturePos;
        Vector2 texturePos1;
        Vector2 texturePos2;
        Vector2 texturePos3;
        ...
        public Game1()
        {
            ...
            textureWin = new Vector2(250,200);
            textureLose = new Vector2(250, 200);
        ...
        protected override void Initialize()
        {
            ...
            texturePos = new Vector2(0, 255);
            acceleration = new Vector2(0, 0);
            damping = new Vector2(0, 0);
        ...
        protected override void LoadContent()
        {
            ...
            winGame = this.Content.Load<Texture2D>("YouWin");
            loseGame = this.Content.Load<Texture2D>("YouLose");
        }
        ...
        protected override void Update(GameTime gameTime)
        {
            ...
            if (IsActive)
            {
                ...
                if (hasJumped == true) //To do only apply in top collide
                {
                    ...
                    damping.Y += -0.1f * i; //Gradually slows down the acceleration
                }
        ...
        protected override void Draw(GameTime gameTime)
        {
            ...
            //Spawn finish flag when player gets 5 coins
            if (this.score >= 5)
            {
                spriteBatch.Draw(flag, texturePos4);
            }
            //Lose screen if timer reaches 0
            if (timer <= 0)
            {
                spriteBatch.Draw(loseGame, textureLose);
            }
            //Win screen if player collides with flag
            if (CollideFlag())
            {
                spriteBatch.Draw(winGame, textureWin);
            }
